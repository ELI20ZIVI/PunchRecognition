...
app.post('/api/upload', upload.single('csvFile'), async (req, res) => {
    ...
    // Usa il Python del venv in Program/sportTech se presente, altrimenti fallback a python3 di sistema.
    const venvPython = path.join(__dirname, '..', '..', 'sportTech', 'bin', 'python');
